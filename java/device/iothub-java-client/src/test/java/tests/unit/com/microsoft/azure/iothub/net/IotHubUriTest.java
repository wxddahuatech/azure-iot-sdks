...
{
    // Tests_SRS_IOTHUBURI_11_007: [The constructor shall return a URI pointing to the address '[iotHubHostname] /devices/[deviceId]/[IoT Hub method path]?api-version=2016-11-14'.]
    // Tests_SRS_IOTHUBURI_11_001: [The string representation of the IoT Hub URI shall be constructed with the format '[iotHubHostname]/devices/[deviceId]/[IoT Hub method path]?api-version=2016-11-14(&[queryFragment]) '.]
    @Test
    public void shortConstructorHasCorrectFormat()
    {
        ...
        final String expectedUriStr =
                "sample.iothubhostname/devices/sample-deviceid/sample-path?api-version=2016-11-14";
    ...
    public void shortConstructorUrlEncodesDeviceId()
    {
        ...
        final String expectedUriStr =
                "sample.iothubhostname/devices/%3F%26sample-deviceid/sample-path?api-version=2016-11-14";
        assertThat(testUriStr, is(expectedUriStr));
    }
    ...
    public void shortConstructorUrlEncodesIotHubMethodPath()
    {
        ...
        final String expectedUriStr =
                "sample.iothubhostname/devices/sample-deviceid/sample-path%3F?api-version=2016-11-14";
        assertThat(testUriStr, is(expectedUriStr));
    }

    // Tests_SRS_IOTHUBURI_11_008: [If queryParams is not empty, the constructor shall return a URI pointing to the address '[iotHubHostname]/devices/[deviceId]/[IoT Hub method path]? api-version=2016-11-14 &[queryFragment] '.]
    @Test
    public void constructorWithQueryFragmentHasCorrectFormat()
    {
        ...
        final String expectedUriStr0 =
                "sample.iothubhostname/devices/sample-deviceid/sample-path?test=true&api-version=2016-11-14";
        final String expectedUriStr1 =
                "sample.iothubhostname/devices/sample-deviceid/sample-path?api-version=2016-11-14&test=true";
        assertThat(testUriStr, is(
                anyOf(equalTo(expectedUriStr0), equalTo(expectedUriStr1))));
    }

    // Tests_SRS_IOTHUBURI_11_009: [If the queryParams is empty, the constructor shall return a URI pointing to the address '[iotHubHostname]/devices/[deviceId]/[IoT Hub method path]?api-version=2016-11-14'.]
    @Test
    ...
    public void constructorUrlEncodesQueryParams()
    {
        ...
        final String expectedUriStr0 =
                "sample.iothubhostname/devices/sample-deviceid/sample-path?test%3F=true%3F&api-version=2016-11-14";
        final String expectedUriStr1 =
                "sample.iothubhostname/devices/sample-deviceid/sample-path?api-version=2016-11-14&test%3F=true%3F";
        assertThat(testUriStr, is(
                anyOf(equalTo(expectedUriStr0), equalTo(expectedUriStr1))));
    }
